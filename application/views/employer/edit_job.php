...
<div class="card p-3">
	...
	<?php echo form_open('employer/edit_job/'.$job_id, array('class'=>'p-3'));?>
	...
	<div class="form-group">
		<?php foreach($skills as $skill) {
			...
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="checkbox" name="skills[]"   value="<?php echo $skill->skill_id;?>"  <?php echo (in_array($skill->skill_id, $skills_array)) ? 'checked' : '';?>>
